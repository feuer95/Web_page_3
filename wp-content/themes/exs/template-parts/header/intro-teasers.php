...
<section id="intro-teasers" class="intro-teasers <?php echo esc_attr( $exs_intro_teaser_section_overlap . $exs_font_size ); ?>">
	<div class="<?php echo esc_attr( $exs_section_layout . ' ' . $exs_intro_teaser_section_padding_top . ' ' . $exs_intro_teaser_section_padding_bottom ); ?>">
		<?php
		...
		?>
		<div class="intro-teasers-grid-wrap layout-gap-30 <?php echo esc_attr( $exs_intro_teaser_section_background . ' ' . $exs_intro_teaser_section_horizontal_padding ); ?>">
