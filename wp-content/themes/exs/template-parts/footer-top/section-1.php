...
<section id="footer-top"
		class="footer-top footer-top-1 <?php echo esc_attr( $exs_footer_top_background . ' ' . $exs_font_size . ' ' . $exs_background_image['class'] ); ?>"
...
>
	...
	<div class="container<?php echo esc_attr( $exs_fluid . ' ' . $exs_extra_padding_top . ' ' . $exs_extra_padding_bottom ); ?>">
		...
		if ( ! empty( $exs_footer_top_heading ) ) :
			...
			?>
			<h3 class="footer_top-heading has-medium-font-size <?php echo esc_attr( $exs_footer_top_heading_animation . ' ' . $exs_footer_top_heading_mt . ' ' . $exs_footer_top_heading_mb ); ?>">
		...
		if ( ! empty( $exs_footer_top_description ) ) :
			...
			?>
			<div class="footer_top-description <?php echo esc_attr( $exs_footer_top_description_animation . ' ' . $exs_footer_top_description_mt . ' ' . $exs_footer_top_description_mb ); ?>">
		...
		if ( ! empty( $exs_footer_top_shortcode ) ) :
			...
			?>
			<div class="footer_top-shortcode <?php echo esc_attr( $exs_footer_top_shortcode_animation . ' ' . $exs_footer_top_shortcode_mt . ' ' . $exs_footer_top_shortcode_mb ); ?>">
