...
?>
<footer id="footer"
		class="footer footer-3 <?php echo esc_attr( $exs_footer_background . ' ' . $exs_font_size . ' ' . $exs_background_image['class'] ); ?>"
...
>
	...
	<div class="container<?php echo esc_attr( $exs_fluid . ' ' . $exs_extra_padding_top . ' ' . $exs_extra_padding_bottom ); ?>">
		...
		?>
		<div class="layout-cols-4 <?php echo esc_attr( 'layout-gap-' . $exs_footer_layout_gap ); ?>">
