...
?>
<!-- wp:heading {"align":"center","className":"animate an__fadeInUp mt-4 mb-05","mt":"mt-4","mb":"mb-05"} -->
<h2 class="has-text-align-center animate an__fadeInUp mt-4 mb-05" id="features">Sem <strong>Imperdiet</strong>
</h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","className":"animate an__fadeInUp"} -->
...
<!-- /wp:paragraph -->
<!-- wp:separator {"className":"animate an__fadeInUp center mt-2","center":true,"mt":"mt-2"} -->
<hr class="wp-block-separator animate an__fadeInUp center mt-2"/>
<!-- /wp:separator -->
<!-- wp:columns {"className":"cols-bordered cols-padding gap-30 pt-2 pb-3","colsBordered":true,"colsPadding":true,"gap":"gap-30","pt":"pt-2","pb":"pb-3"} -->
<div class="wp-block-columns cols-bordered cols-padding gap-30 pt-2 pb-3">
	<!-- wp:column {"className":"animate an__fadeInLeft"} -->
	<div class="wp-block-column animate an__fadeInLeft">
		...
		<!-- /wp:paragraph -->
		<!-- wp:button {"align":"center","className":"mb-1","mb":"mb-1"} -->
	...
	<!-- /wp:column -->
	<!-- wp:column {"className":"animate an__fadeInUp"} -->
	...
	<!-- /wp:column -->
	<!-- wp:column {"className":"animate an__fadeInRight"} -->
...
<!-- /wp:columns -->
<!-- wp:heading {"align":"center","className":"animate an__fadeInUp mb-05","mb":"mb-05"} -->
<h2 class="has-text-align-center animate an__fadeInUp mb-05">Voluptate Velit <strong>Cillum</strong>
</h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","className":"animate an__fadeInUp mb-2","mb":"mb-2"} -->
<p class="has-text-align-center animate an__fadeInUp mb-2">Reprehenderit in voluptate velit esse cillum dolore eu
	fugiat nulla
	pariatur.</p>
<!-- /wp:paragraph -->
<!-- wp:separator {"className":"animate an__fadeInUp center mt-0 mb-0","center":true,"mt":"mt-0","mb":"mb-0"} -->
<hr class="wp-block-separator animate an__fadeInUp center mt-0 mb-0"/>
<!-- /wp:separator -->
<!-- wp:columns {"className":"animate an__fadeInUp section cols-single-sm gap-50 pt-2","section":true,"colsSingle":"cols-single-sm","gap":"gap-50","pt":"pt-2"} -->
...
<!-- /wp:columns -->
<!-- wp:columns {"className":"animate an__fadeInUp section cols-single-sm gap-50 pb-5","section":true,"colsSingle":"cols-single-sm","gap":"gap-50","pb":"pb-5"} -->
<div class="wp-block-columns animate an__fadeInUp section cols-single-sm gap-50 pb-5">
	...
	<div class="wp-block-column">
		...
		<div class="wp-block-columns cols-single-none gap-15">
			<!-- wp:column {"width":20,"className":""} -->
			<div class="wp-block-column" style="flex-basis:20%">
				<!-- wp:image {"id":568,"width":50,"height":50,"sizeSlug":"large","className":""} -->
				<figure class="wp-block-image size-large is-resized">
					<img
						src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/color-wand-outline.png" alt="" class="wp-image-568" width="50"
						height="50"/>
				</figure>
				<!-- /wp:image -->
			</div>
	...
	<div class="wp-block-column">
		...
		<div class="wp-block-columns cols-single-none gap-15">
			<!-- wp:column {"width":20,"className":""} -->
			<div class="wp-block-column" style="flex-basis:20%">
				<!-- wp:image {"id":569,"width":50,"height":50,"sizeSlug":"large","linkDestination":"custom","className":""} -->
				<figure class="wp-block-image size-large is-resized">
					<a href="#">
						<img
							src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/help-buoy.png" alt="" class="wp-image-569" width="50"
							height="50"/>
					</a>
				</figure>
				<!-- /wp:image -->
	...
	<div class="wp-block-column">
		...
		<div class="wp-block-columns cols-single-none gap-15 pb-2">
			<!-- wp:column {"width":20,"className":""} -->
			<div class="wp-block-column" style="flex-basis:20%">
				<!-- wp:image {"id":570,"width":50,"height":50,"sizeSlug":"large","className":""} -->
				<figure class="wp-block-image size-large is-resized">
					<img
						src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/chatbox-outline.png" alt="" class="wp-image-570" width="50"
						height="50"/>
				</figure>
				<!-- /wp:image -->
			</div>
...
<!-- /wp:columns -->
<!-- wp:group {"className":"section pt-5 l m decor decor-t chev-t","section":true,"pt":"pt-5","background":"l m","decorTop":"decor decor-t chev-t"} -->
<div class="wp-block-group section pt-5 l m decor decor-t chev-t">
	<div class="wp-block-group__inner-container">
		<!-- wp:heading {"align":"center","className":"animate an__fadeInUp mb-0","mb":"mb-0"} -->
...
<!-- /wp:group -->
<!-- wp:columns {"className":"section cols-highlight cols-shadow cols-padding pt-2 pb-1 l m","section":true,"colsHighlight":true,"colsShadow":true,"colsPadding":true,"pt":"pt-2","pb":"pb-1","background":"l m"} -->
...
<!-- /wp:columns -->
<!-- wp:columns {"className":"section cols-highlight cols-shadow cols-padding pt-1 pb-5 l m decor decor-b arr-b","section":true,"colsHighlight":true,"colsShadow":true,"colsPadding":true,"pt":"pt-1","pb":"pb-5","background":"l m","decorBottom":"decor decor-b arr-b"} -->
	...
	<div class="wp-block-column animate an__fadeInLeft">
		...
		<figure class="wp-block-pullquote">
			<blockquote>
				...
				<cite>
					<img class="wp-image-444" style="width: 50px;" src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/person.png" alt="">
	...
	<div class="wp-block-column animate an__fadeInRight">
		...
		<figure class="wp-block-pullquote">
			<blockquote>
				...
				<cite>
					<img class="wp-image-442" style="width: 50px;" src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/person.png" alt="">
					<br>Mollit Anim,
...
<!-- /wp:columns -->
<!-- wp:cover {"url":"<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/cup.jpg","id":8,"hasParallax":true,"align":"full","className":""} -->
<div class="wp-block-cover alignfull has-background-dim has-parallax" style="background-image:url(<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/cup.jpg)">
	<div class="wp-block-cover__inner-container">
		<!-- wp:heading {"align":"center","level":1,"className":"animate an__lightSpeedIn mt-2","mt":"mt-2"} -->
		<h1 class="has-text-align-center animate an__lightSpeedIn mt-2">
			...
			enim ad!</h1>
		<!-- /wp:heading -->
		<!-- wp:button {"align":"center","className":"is-style-fill animate an__lightSpeedIn mb-3","mb":"mb-3"} -->
...
<!-- /wp:cover -->
<!-- wp:group {"className":"section pt-4 l decor decor-t chev-t","section":true,"pt":"pt-4","background":"l","decorTop":"decor decor-t chev-t"} -->
<div class="wp-block-group section pt-4 l decor decor-t chev-t">
	<div class="wp-block-group__inner-container">
		...
		<!-- /wp:paragraph -->
		<!-- wp:separator {"className":"animate an__fadeInUp center mt-1 mb-0","center":true,"mt":"mt-1","mb":"mb-0"} -->
		<hr class="wp-block-separator animate an__fadeInUp center mt-1 mb-0"/>
		<!-- /wp:separator -->
	</div>
</div>
<!-- /wp:group -->
<!-- wp:columns {"className":"cols-shadow-hover cols-padding cols-single-sm gap-30 pt-2 pb-3","colsShadowHover":true,"colsPadding":true,"colsSingle":"cols-single-sm","gap":"gap-30","pt":"pt-2","pb":"pb-3"} -->
<div class="wp-block-columns cols-shadow-hover cols-padding cols-single-sm gap-30 pt-2 pb-3">
	<!-- wp:column {"className":"animate an__bounceIn"} -->
...
<!-- /wp:columns -->
<!-- wp:separator {"className":"alignfull mb-0","width":"alignfull","mb":"mb-0"} -->
<hr class="wp-block-separator alignfull mb-0"/>
<!-- /wp:separator -->
<!-- wp:group {"className":"section pt-4 pb-4 l m","section":true,"pt":"pt-4","pb":"pb-4","background":"l m"} -->
<div class="wp-block-group section pt-4 pb-4 l m">
	<div class="wp-block-group__inner-container">
		<!-- wp:heading {"align":"center","className":"animate an__fadeInUp mt-1 mb-0","mt":"mt-1","mb":"mb-0"} -->
		...
		<!-- /wp:paragraph -->
		<!-- wp:separator {"className":"animate an__fadeInUp center mt-2 mb-2","center":true,"mt":"mt-2","mb":"mb-2"} -->
		<hr class="wp-block-separator animate an__fadeInUp center mt-2 mb-2"/>
		<!-- /wp:separator -->
		<!-- wp:gallery {"ids":[608,606,607,604,605,602,603,601,610,611,612,613],"columns":6,"imageCrop":false,"className":"animate an__fadeInUp"} -->
		<figure class="wp-block-gallery columns-6  animate an__fadeInUp">
			<ul class="blocks-gallery-grid">
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="608"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="606"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="607"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="604"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="605"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="602"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="603"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="601"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="610"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="611"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="612"/>
					</figure>
				</li>
				<li class="blocks-gallery-item">
					<figure>
						<img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/logo.png" alt="" data-id="613"/>
					</figure>
				</li>
			</ul>
		</figure>
...
<div class="wp-block-group">
	<div class="wp-block-group__inner-container">
		<!-- wp:separator {"className":"alignfull mt-0 mb-4","width":"alignfull","mt":"mt-0","mb":"mb-4"} -->
		<hr class="wp-block-separator alignfull mt-0 mb-4"/>
		<!-- /wp:separator -->
		<!-- wp:heading {"align":"center","className":"animate an__fadeInUp mt-3 mb-05","mt":"mt-3","mb":"mb-05"} -->
		...
		<p class="has-text-align-center animate an__fadeInUp">Orem ipsum dolor sit amet, consectetur adipisicing elit<br>nulla
			deserunt</p>
		<!-- /wp:paragraph -->
		<!-- wp:separator {"className":"animate an__fadeInUp center mt-1 mb-2","center":true,"mt":"mt-1","mb":"mb-2"} -->
		<hr class="wp-block-separator animate an__fadeInUp center mt-1 mb-2"/>
		<!-- /wp:separator -->
	</div>
</div>
<!-- /wp:group -->
<!-- wp:latest-posts {"className":"animate an__fadeInUp","postsToShow":4,"excerptLength":12,"displayPostDate":true,"postLayout":"grid","columns":4,"displayFeaturedImage":true,"featuredImageSizeSlug":"large"} /-->
<!-- wp:spacer {"height":70,"className":""} -->
