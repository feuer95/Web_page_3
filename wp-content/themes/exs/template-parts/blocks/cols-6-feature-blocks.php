...
<!-- wp:columns {"className":"gap-30 pt-5 pb-5","gap":"gap-30","pt":"pt-5","pb":"pb-5"} -->
<div class="wp-block-columns gap-30 pt-5 pb-5"><!-- wp:column {"className":"animate an__zoomIn"} -->
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":743,"width":75,"height":75,"sizeSlug":"large","className":"is-style-bg-colormain-round"} -->
	...
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":745,"width":75,"height":75,"sizeSlug":"large","className":"is-style-bg-colormain-round"} -->
	...
	<!-- wp:column {"className":"animate an__zoomIn"} -->
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":746,"width":75,"height":75,"sizeSlug":"large","className":"is-style-bg-colormain-round"} -->
	...
	<!-- wp:column {"className":"animate an__zoomIn"} -->
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":748,"width":75,"height":75,"sizeSlug":"large","className":"is-style-bg-colormain-round"} -->
	...
	<!-- wp:column {"className":"animate an__zoomIn"} -->
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":750,"width":75,"height":75,"sizeSlug":"full","className":"is-style-bg-colormain-round"} -->
	...
	<!-- wp:column {"className":"animate an__zoomIn"} -->
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":751,"width":75,"height":75,"sizeSlug":"large","className":"is-style-bg-colormain-round"} -->
