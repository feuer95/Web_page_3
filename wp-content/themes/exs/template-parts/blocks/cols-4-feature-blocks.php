...
?>
<!-- wp:columns {"className":"cols-single-sm gap-30 pt-5 pb-3","colsSingle":"cols-single-sm","gap":"gap-30","pt":"pt-5","pb":"pb-3"} -->
<div class="wp-block-columns cols-single-sm gap-30 pt-5 pb-3"><!-- wp:column {"className":"animate an__zoomIn"} -->
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":270,"width":75,"height":75,"sizeSlug":"large","className":""} -->
	...
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":479,"width":75,"height":75,"sizeSlug":"large","className":""} -->
	...
	<!-- wp:column {"className":"animate an__zoomIn"} -->
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":480,"width":75,"height":75,"sizeSlug":"large","className":"is-style-default"} -->
	...
	<!-- wp:column {"className":"animate an__zoomIn"} -->
	<div class="wp-block-column animate an__zoomIn"><!-- wp:image {"align":"center","id":487,"width":75,"height":75,"sizeSlug":"large","className":"is-style-default"} -->
